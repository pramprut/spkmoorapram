...
foreach ($optimasi as $id_optimasi => $value) {
   ...
   if ($rank) {
      $sqlInput = "INSERT INTO tabel_hasil (nama, nilai,tanggal)
        VALUES ('$nama_simpan','$optimasi[$id_optimasi]','$tgl')";
      $db->query($sqlInput);
   }
   /*      echo "<br>=======<br>";
*/
...
echo "<script>alert('DATA BERHASIL DIHITUNG');window.location = '../../content.php?module=list_detail_siswa';</script>";

?>
<!-- <a href="../../index.php?module=list_hasil"> <button>Lihat Rekomendasi</button></a> -->